...
class Player(Widget):
    ...
    def move(self):
        ...
        self.close_point = argmin(
            lambda x: distance(self.pos, bound[x]),
            close_list[self.close_point - 1],
            self.close_point,
        )
